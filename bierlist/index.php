                ...
                echo "<tr>
                        ...
                        <td>
                            <form method='POST' id='form-{$row["id"]}'>
                                ...
                                <div class='rating'>
                                    <span class='stars star-{$row["id"]}' onclick='setRating({$row["id"]}, 1)' onmouseover='highlightStars({$row["id"]}, 1)'>⭐</span>
                                    <span class='stars star-{$row["id"]}' onclick='setRating({$row["id"]}, 2)' onmouseover='highlightStars({$row["id"]}, 2)'>⭐</span>
                                    <span class='stars star-{$row["id"]}' onclick='setRating({$row["id"]}, 3)' onmouseover='highlightStars({$row["id"]}, 3)'>⭐</span>
                                    <span class='stars star-{$row["id"]}' onclick='setRating({$row["id"]}, 4)' onmouseover='highlightStars({$row["id"]}, 4)'>⭐</span>
                                    <span class='stars star-{$row["id"]}' onclick='setRating({$row["id"]}, 5)' onmouseover='highlightStars({$row["id"]}, 5)'>⭐</span>
                                </div>
                            </form>
                        </td>
                      </tr>";
